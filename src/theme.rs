...
impl Theme {
    ...
    pub fn darcula() -> Self {
        Self {
            name: "darcula".into(),
            bg: Rgb::new(43, 43, 43),
            sidebar_bg: Rgb::new(60, 63, 65),
            topbar_bg: Rgb::new(50, 52, 54),
            surface: Rgb::new(69, 73, 74),
            surface_alt: Rgb::new(82, 88, 90),
            surface_hi: Rgb::new(96, 106, 109),
            border: Rgb::new(50, 52, 54),
            border_strong: Rgb::new(100, 106, 112),
            divider: Rgb::new(50, 52, 54),
            text: Rgb::new(187, 187, 187),
            text_hover: Rgb::new(225, 225, 225),
            text_muted: Rgb::new(140, 140, 140),
            text_header: Rgb::new(150, 150, 150),
            accent: Rgb::new(204, 120, 50),
            row_hover: Rgb::new(56, 58, 60),
            row_active: Rgb::new(74, 88, 113),
            focus_border: Rgb::new(87, 151, 206),
            inactive_border: Rgb::new(50, 52, 54),
    ...
    pub fn vscode_light() -> Self {
        Self {
            ...
            topbar_bg: Rgb::new(221, 221, 221),
            surface: Rgb::new(236, 236, 236),
            surface_alt: Rgb::new(220, 220, 220),
            surface_hi: Rgb::new(200, 200, 200),
            border: Rgb::new(215, 215, 215),
            border_strong: Rgb::new(180, 180, 180),
            divider: Rgb::new(225, 225, 225),
            text: Rgb::new(51, 51, 51),
            text_hover: Rgb::new(0, 0, 0),
            text_muted: Rgb::new(110, 110, 110),
            text_header: Rgb::new(97, 97, 97),
            accent: Rgb::new(0, 122, 204),
            row_hover: Rgb::new(232, 232, 232),
            row_active: Rgb::new(204, 226, 255),
            focus_border: Rgb::new(0, 122, 204),
            inactive_border: Rgb::new(215, 215, 215),
            error: Rgb::new(205, 49, 49),
            success: Rgb::new(0, 128, 0),
            warning: Rgb::new(191, 132, 0),
            terminal_bg: Rgb::new(255, 255, 255),
            terminal_fg: Rgb::new(51, 51, 51),
        }
    }
