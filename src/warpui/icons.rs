//! Phosphor (regular) icon codepoints — the subset Crane uses, values matching
//! egui_phosphor 0.12. Rendered as `Text` in the "phosphor" font family loaded
//! from `assets/Phosphor.ttf`. (Inlined to avoid pulling egui into this crate.)
